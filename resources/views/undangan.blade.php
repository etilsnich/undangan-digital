...
<body class="bg-stone-100 antialiased flex justify-center items-center min-h-screen relative overflow-x-hidden">
    ...
    <div id="cover-page" class="fixed inset-0 z-50 max-w-md mx-auto bg-cover-watercolor flex flex-col justify-between items-center py-12 px-6 shadow-2xl transition-all duration-1000 ease-in-out border-x border-blue-200 overflow-hidden">
        ...
        <img src="{{ asset('images/ornamen-tengah.jpg') }}" class="absolute top-[25%] left-[-50px] w-[140px] z-10 pointer-events-none opacity-70 -rotate-12 mix-blend-multiply" alt="Ornamen Kiri 1">
        <img src="{{ asset('images/ornamen-tengah.jpg') }}" class="absolute top-[50%] left-[-70px] w-[180px] z-10 pointer-events-none opacity-80 rotate-45 mix-blend-multiply" alt="Ornamen Kiri 2">
        ...
        <img src="{{ asset('images/ornamen-tengah.jpg') }}" class="absolute top-[20%] right-[-60px] w-[150px] z-10 pointer-events-none opacity-70 rotate-12 scale-x-[-1] mix-blend-multiply" alt="Ornamen Kanan 1">
        <img src="{{ asset('images/ornamen-tengah.jpg') }}" class="absolute top-[45%] right-[-80px] w-[190px] z-10 pointer-events-none opacity-80 -rotate-45 scale-x-[-1] mix-blend-multiply" alt="Ornamen Kanan 2">
        <img src="{{ asset('images/ornamen-tengah.jpg') }}" class="absolute top-[70%] right-[-50px] w-[140px] z-10 pointer-events-none opacity-60 rotate-90 scale-x-[-1] mix-blend-multiply" alt="Ornamen Kanan 3">
